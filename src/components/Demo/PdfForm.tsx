...
// //Function to create form data for post api
// const createFormData = (singleFile, body = {}) => {
//   const data = new FormData();
//     data.append('myfile', {
...
//         fetch(documentPostUrl, {
//           method: 'POST',
//           body: createFormData([singleFile]),
//           headers: {authtoken: 'allow'},
//         }).then(response => response.json()),
//       ),
//     )
...
//         {file.length > 0 ? selectedDocText : getADocText}
//       </Text>
//       {file.length > 0 && (
//         <>
//           <Text
...
//             numberOfLines={3}
//             ellipsizeMode="tail">
//             {file.map(fileItem => fileItem.name).join('\n')}
//           </Text>
...
//           {choose} {file.length > 0 && another} {fileText}
//         </Text>
//       </TouchableOpacity>
//     </View>
//   );
